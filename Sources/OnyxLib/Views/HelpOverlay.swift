...
struct HelpOverlay: View {
    ...
    private let globalShortcuts: [Shortcut] = [
        ...
        .init(keys: "⌘Y", label: "Preview the selected file (works from the terminal)"),
        .init(keys: "⌘⌥←", label: "Move focus to the terminal"),
        .init(keys: "⌘⌥→", label: "Move focus to the open side panel"),
    ...
    private let monitorShortcuts: [Shortcut] = [
        ...
        .init(keys: "D", label: "Simple mode: sessions + today's reminders on the left"),
    ]
